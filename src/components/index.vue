                  ...
                  <div id="leftEdit" class="ofh" :ref="'leftEdit'+index" v-if="site.name=='left'">
                    <div class="fl w19" :ref="'leftEdit'+index+'w19'">
                      ...
                      <div v-else v-for="(site1,index1) in site.w19">
                        <component :is="site1.name" style="margin: 0 auto" :ref="'con'+index+'w19'+index1" :dataref="'con'+index+'w19'+index1"
                          :dataName="site1.mkname" data="" :datamk="site1.name" dataLocation1="con" :dataLocation2="index"
                    ...
                    <div class="fr w75" :ref="'leftEdit'+index+'w75'">
                      ...
                      <div v-else v-for="(site1,index1) in site.w75">
                        <component :is="site1.name" :ref="'con'+index+'w75'+index1" :dataref="'con'+index+'w75'+index1"
                          :dataName="site1.mkname" style="margin: 0 auto " data="" :datamk="site1.name" dataLocation1="con"
                          :dataLocation2="index" dataLocation3="w75" :dataLocation4="index1" :datalength="site.w75.length-1"></component>
                      </div>
                    </div>
                  </div>
                  <!-- right -->
                    ...
                    <div class="fr w19" :ref="'rightEdit'+index+'w19'">
                      ...
                      <div v-else v-for="(site1,index1) in site.w19">
                        <component :is="site1.name" :ref="'con'+index+'w19'+index1" :dataref="'con'+index+'w19'+index1"
                          :dataName="site1.mkname" style="margin: 0 auto " data="" :datamk="site1.name" dataLocation1="con"
                          :dataLocation2="index" dataLocation3="w19" :dataLocation4="index1" :datalength="site.w19.length-1"></component>
                      </div>
                    </div>
                  </div>
                  <!-- center -->
                    ...
                    <div class="fl w1920">
                      ...
                      <div v-else v-for="(site1,index1) in site.w1920">
                        <component :is="site1.name" style="margin: 0 auto " :ref="'conter'+index+site1.name+index1"
                          :dataref="'conter'+index+site1.name+index1" :dataName="site1.mkname" data="" :datamk="site1.name"
                          dataLocation1="con" :dataLocation2="index" dataLocation3="center" :dataLocation4="index1"
                          :datalength="site.w1920.length-1"></component>
                      </div>
                    </div>
                  </div>
                </div>
                          ...
                          <div class="fl" :ref="'dy'+index+'leftw19'">
                            ...
                            <div v-for="(site1,index1) in site.w19">
                              <guanliButton :ref="'bjcon'+index+'w19'+index1" :dataref="'bjcon'+index+'w19'+index1"
                                :datamkname="site1.mkname" :dataName="site1.name" dataLocation1="con" :dataLocation2="index"
                                dataLocation3="w19" :dataLocation4="index1" :datalength=" site.w19.length-1">
                              </guanliButton>
                            </div>
                          </div>
                          <div class="fr" :ref="'dy'+index+'leftw75'">
                            ...
                            <div v-for="(site1,index1) in site.w75">
                              <guanliButton :ref="'bjcon'+index+'w75'+index1" :dataref="'bjcon'+index+'w75'+index1"
                                :datamkname="site1.mkname" :dataName="site1.name" dataLocation1="con" :dataLocation2="index"
                                dataLocation3="w75" :dataLocation4="index1" :datalength=" site.w75.length-1">
                              </guanliButton>
                            </div>
                          </div>
                          <div class="clear"></div>
                          ...
                          <div class="layout_body">
                            ...
                            <div v-for="(site1,index1) in site.w1920">
                              <guanliButton :ref="'dy'+index+'center'+index1" :dataref="'dy'+index+'center'+index1"
                                :datamkname="site1.mkname" :dataName="site1.name" dataLocation1="con" :dataLocation2="index"
                                dataLocation3="center" :dataLocation4="index1" :datalength=" site.w1920.length-1">
                              </guanliButton>
                            </div>
                          </div>
                          <div class="clear"></div>
    ...
    methods: {
      ...
      add_nav() {
        ...
        if (that.layout_data.hd.length == 0) {
          console.log(that.layout_data.hd)
          console.log("添加了没")
          var data = {
            name: "mknav",
            mkname: "导航",
