   ...
   <div :ref="dataref" id="mk7" class="pr" @mouseover="hoverActive=true" @mouseout="hoverActive=false">
      <div class="link">
         ...
         <div class="dialog" v-if="isShow">
            <div class="dialog-cover" @click="isShow=false"></div>
            <div class="dialog-cont">
               ...
               <div class="dialog-btn">
                  <button type="button" class="save" @click="savedata();isShow = false">保存</button>
                  <button type="button" class="cancel" @click="isShow = false">取消</button>
               </div>
            </div>
         </div>
      </div>
